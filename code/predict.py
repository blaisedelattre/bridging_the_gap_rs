...
parser.add_argument(
    "--dataset", choices=DATASETS, help="which dataset", default="cifar10"
)
parser.add_argument(
    "--base_classifier", type=str, help="path to saved pytorch model of base classifier"
)
parser.add_argument(
    "--sigma", type=float, help="noise hyperparameter for smoothing", default=0.25
)
...
if __name__ == "__main__":
    ...
    args.outfile = (
        f"clean_predict_{args.dataset}_{args.sigma}_N_{args.N}_alpha_{args.alpha}.txt"
    )
